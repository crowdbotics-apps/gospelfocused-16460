"""gospelfocused_16460 URL Configuration
...
admin.site.site_header = "GospelFocused"
admin.site.site_title = "GospelFocused Admin Portal"
admin.site.index_title = "GospelFocused Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="GospelFocused API",
        default_version="v1",
        description="API documentation for GospelFocused App",
    ),
    public=True,
